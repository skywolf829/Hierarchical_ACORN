...
--octree_depth_end 1 --save_name pluto_2models_size1 --target_signal TrainingData/pluto.h5 \
...
--octree_depth_end 3 --save_name pluto_2models_size3 --target_signal TrainingData/pluto.h5 \
--num_channels 3 --mode 2D --local_queries_per_iter 1000000
