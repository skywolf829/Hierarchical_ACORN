...
python -u Code/train.py --use_residual true --FC_size_exp_start 1.0 --FC_size_exp_grow 1.0 \
--octree_depth_end 7 --save_name Pluto_LRstep_8channels --target_signal TrainingData/pluto.h5 \
--num_channels 3 --mode 2D --local_queries_per_iter 1000000 --train_distributed false --num_nodes 1 \
--gpus_per_node 8 --feat_grid_channels 8
